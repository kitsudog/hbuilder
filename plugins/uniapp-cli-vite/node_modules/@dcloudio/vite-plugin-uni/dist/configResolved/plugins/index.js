...
const debugPlugin = (0, debug_1.default)('vite:uni:plugin');
...
function initPlugins(config, options) {
    ...
    addPlugin(plugins, (0, pre_1.uniPrePlugin)((0, shared_1.extend)(uniPrePluginOptions, options)), 0, 'pre');
    addPlugin(plugins, (0, preCss_1.uniPreCssPlugin)((0, shared_1.extend)(uniPreCssPluginOptions, options)), 'vite:css');
