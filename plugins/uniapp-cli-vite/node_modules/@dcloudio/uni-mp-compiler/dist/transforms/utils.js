...
function rewriteExpression(node, context, babelNode, scope = context.currentScope, { property, ignoreLiteral } = { property: true, ignoreLiteral: false }) {
    var _a;
    ...
    if (property) {
        scope.properties.push((0, types_1.objectProperty)((0, types_1.identifier)(id), babelNode));
    }
    // 在v-for中包含的v-if块，所有变量需要补充当前v-for value前缀
    if ((0, transform_1.isVIfScope)(scope)) {
        if ((0, transform_1.isVForScope)(scope.parentScope)) {
            return (0, compiler_core_1.createSimpleExpression)(scope.parentScope.valueAlias + '.' + id);
        }
        return (0, compiler_core_1.createSimpleExpression)(id);
    }
    else if ((0, transform_1.isVForScope)(scope)) {
        return (0, compiler_core_1.createSimpleExpression)(scope.valueAlias + '.' + id);
    }
    return (0, compiler_core_1.createSimpleExpression)(id);
}
