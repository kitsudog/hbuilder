...
function transformElementVModel(props, node, context) {
    ...
    if (dirs.length === 2) {
        ...
        if (inputExp) {
            inputExp.children[2] = combineVOn(dirs[1].exp, inputExp.children[2], context);
            dirs.length = 1;
        }
        else {
...
function combineVOn(exp1, exp2, context) {
...
function transformComponentVModel(props, context) {
    return {
...
function transformVModel(props, context, { binding, event, formatEventCode, }) {
    if (props.length !== 2) {
        return [];
    }
