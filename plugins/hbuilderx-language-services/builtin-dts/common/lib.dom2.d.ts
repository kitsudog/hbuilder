/// <reference path="../uniapp@vue2/node_modules/@dcloudio/types/lib/HBuilderX.d.ts" />
...
interface Document {
  ...
  querySelector<E extends Element = Element>(selectors: string | HBuilderX.cssSelectorString): E | null;
}
