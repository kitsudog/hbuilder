import Vue$1, { VNode, VueConstructor, ComponentOptions, AsyncComponent, VNodeDirective, CreateElement,onRenderTracked,onRenderTriggered, ComponentOptionsBase } from 'vue';
declare type Data = {
    [key: string]: unknown;
};
